...
**Real-time collaboration health monitoring engine for software team projects.**

v2: NLI-enhanced work classification, collaboration metrics (Gini, entropy, bus factor),
multi-signal fusion, circuit breaker resilience. See [docs/](docs/) for methodology.
